        ...
        with open(os.path.join(directory, fname), "wb") as wf:
            ...
            for partition in self.partentries:
                ...
                mstr += f"\t<program SECTOR_SIZE_IN_BYTES=\"{sectorsize}\" " + \
                        ...
                        f"size_in_KB=\"{(partition.sector * sectorsize / 1024):.1f}\" sparse=\"{sparse}\" " + \
            ...
            mstr += f"\t<program SECTOR_SIZE_IN_BYTES=\"{sectorsize}\" " + \
                    ...
                    f"filename=\"gpt_main{str(lun)}.bin\" label=\"PrimaryGPT\" " + \
                    ...
                    f"sparse=\"{sparse}\" start_byte_hex=\"0x0\" start_sector=\"0\"/>\n"
